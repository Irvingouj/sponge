...
export default function About() {
	...
	useEffect(() => {
		const loadContent = async () => {
			const contentPath =
				activeLocale === "zh" ? "content/about-zh.md" : "content/about-en.md";
			const content = await loadMarkdownContent(contentPath);
			setMarkdownContent(content);
		};

		loadContent(); // Call the function to load the content
	}, [activeLocale]);
