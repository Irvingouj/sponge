...
export const experiencesDataZn = [
	{
		...
		location: "spongebob.vip",
		description:
			"凭借浓厚的兴趣，自主学习搭建起个人网站，相当于完成了一个心愿。从服务器和域名的购买注册到后续的复杂备案，以及最终项目的全部部署上线，一个人通过大量的学习和查阅资料走完了全程，这期间遇到的Bug不少，但是不断地学习让我感到快乐！动力十足！",
		icon: React.createElement(FaGlobe),
	...
	},
	{
		...
		location: "芥泥糖",
		description:
			"10月18日正式成为网易云音乐合伙人，异常高兴！自从上大学后，选择的娱乐方式最多的就是听歌，音乐能振奋我，让我积极的面对种种的困难，是我在学习生活中舒缓压力的不可缺少的一部分。不过有时候会听歌上瘾，甚至会随着旋律摇摆身体，也会因为爱上一首歌而为它特地制作视频。",
		icon: React.createElement(LuMusic),
		date: "2024年10月 - 持续中",
	},
	{
		...
		location: "SpongeYuqi",
		description:
			"9月12日深夜我记着我还在开着电脑在寝室进行学习，室友们都已经躺床上了，我开着台灯操作到入驻Github这个大家庭成功这一步骤，我深感喜悦，因为我意识到，这是又一次的新尝试，人生就是不断的尝试和历练自己，接触不同的领域就是不断地刷新自我，提升自我，我乐在其中！",
		icon: React.createElement(FaGithub),
		date: "2024年9月 - 践行中",
	},
];
...
export const projectsData = [
	{
		...
		desc_zh:
			"旨在创新设计一款多功能抗灾坦克履带车，其集成了高强度履带、深度相机、热融合夜视仪、消防喷头、液压破拆钳、激光雷达、爆闪警示灯以及UWB定位系统等多个功能模块于一身，这种高度集成化设计极大地提高了单一平台的综合救援能力。",
	...
	},
	{
		...
		desc_zh:
			"该服务集成了用户登录、验证、评论、上传文件、删除资源等功能，汇集了nodejs基本的应用框架和接口用法，并使用Navicate作为后台Mysql数据集成管理，通过Insomnia验证项目。",
	...
	},
	{
		...
		description:
			"The intelligent medical system monitoring platform is committed to improving hospital operation efficiency and optimizing resource allocation, while strengthening patient experience and service quality, and forming a comprehensive hospital operation monitoring system.",
		desc_zh:
			"本项目旨在构建一个基于AIRIOT平台的智能医疗系统监管平台，致力于提升医院运营效率、优化资源配置与管理，同时强化患者体验和服务质量，形成全面的医院运营监控体系。通过操作快捷入口，管理者可快速访问各详细管理模块，实现深度数据挖掘与精细化管理。",
	...
	},
	{
		...
		description:
			"I participated in this competition as a representative of Harbin Institute of Technology in my freshman year. At that time, my research ability and debate ability were relatively weak. This competition laid the foundation for me to dare to go to the platform, be willing to show myself, constantly improve myself and explore myself.",
		desc_zh:
			"这项比赛是我在大一时作为代表前往哈尔滨工业大学参加的，那时候还很稚嫩，无论是研究能力还是辩论能力，都是比较弱的。对于我来说，这次竞赛奠定了我大学敢于上讲台，乐于展现自己，不断提升自我，自我探索的基础。",
	...
	},
	{
		...
		title_zh: "绘画 & 反思",
		description: `When I was a child, I could be said to be a painting genius, but as I grew up, I gradually stopped picking up a pen, perhaps because of laziness, hopelessness, and no motivation to stick to it. But from the beginning to the end, the artistic cells still flow, which also allows me to find beauty, create beauty, and strive to do everything I want to do well, adding personal characteristics. 
            `,
		desc_zh:
			"小时候，可谓是绘画天才，但随着长大，渐渐不再拿起笔，可能因为懒惰、无望，也没有坚持下去的动力，即使是天才，也逐渐淹没才能。但是从始至终，艺术细胞依旧流淌，这也让我能发现美，创造美，力求每件我想要做好的事都精益求精，加入个人的特色。这也造就了我爱探索新事物的品质，例如此次个人网站的搭建！",
